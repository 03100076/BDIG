...
_SOLVERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='rec_prec_thr', full_name='caffe.SolverParameter.rec_prec_thr', index=44,
...
_PRIORBOXPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_default', full_name='caffe.PriorBoxParameter.use_default', index=13,
